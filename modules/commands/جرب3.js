...
module.exports.handleEvent = async function({ api, event }) {
    ...
    if (event.senderID !== api.getCurrentUserID() && body.endsWith("؟")) {
        ...
        const apiUrl = `https://gpt-4-ayoub-nino.koyeb.app/hercai/api?content=${encodeURIComponent(question)}`;
        ...
        try {
            ...
            if (apiResponse.reply) {
                ...
                if (answer.trim() !== "") {
                    ...
                    gttsService.save('./commands/cache/gpt4.mp3 ', function () {
                      api.sendMessage(`🥷🏻 𝗚𝗣𝗧-4 ( ⓃⒾⓃⓄ )\n\n🗨️: ${formattedReply}\n\nاتـمـنـى ان يـفـيـدك هـذا الـجـواب ✨`, event.threadID , event.messageID);

                      api.sendMessage(
                        {
                          attachment: fs.createReadStream('./commands/cache/gpt4_response.mp3'),
                          body: '🔊 ⓃⒾⓃⓄ 𝗚𝗣𝗧-4 ( 𝗩𝗼𝗶𝗰𝗲 )',
                          mentions: [
                            {
                              tag: 'GPT-4 Response',
